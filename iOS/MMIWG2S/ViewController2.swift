...
class ViewController2:UIViewController
{
    ...
    override func viewDidLoad()
    {
        super.viewDidLoad()
         ...
         let gradient = UIImage(named:"Rectangle 1-2.png")
...
//        buttonNext.addSubview(pc4View)
        ...
        pc2View.backgroundColor = UIColor.red
 ...
 /*
    ...
    */
    ...
    @objc func changePage(sender:AnyObject) ->() {
       if (delegate != nil) {
           delegate?.vc2tovc3()       /* let x = CGFloat(pageControl.currentPage) * scrollView.frame.size.width
